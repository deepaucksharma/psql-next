...
require (
	github.com/database-intelligence-mvp/receivers/postgresqlquery v0.0.0
...
replace (
	github.com/database-intelligence-mvp/receivers/postgresqlquery => ./receivers/postgresqlquery
)