module github.com/database-intelligence/db-intel/distributions/minimal
...
require (
	...
	go.opentelemetry.io/collector/component/componenttest v0.105.0 // indirect
...
replace (
	...
	github.com/database-intelligence/db-intel/components/common/featuredetector => ../../common/featuredetector
