...
type TestSuite interface {
	...
	Setup(env TestEnvironmentInterface) error

	// Execute runs all test cases in the suite
	Execute(ctx context.Context, env TestEnvironmentInterface) (*TestResult, error)
...
// TestEnvironmentInterface represents the test execution environment interface
...
type EnvironmentManager interface {
	...
	Provision(ctx context.Context) (TestEnvironmentInterface, error)
