...
require (
	...
	github.com/deepaksharma/db-otel/common/queryselector v0.0.0-00010101000000-000000000000
	github.com/deepaksharma/db-otel/internal/database v0.0.0-00010101000000-000000000000
