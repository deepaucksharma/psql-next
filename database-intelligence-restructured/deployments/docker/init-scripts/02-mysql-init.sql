-- MySQL initialization script for database intelligence monitoring
...
-- Enable general query log (for testing only)
SET GLOBAL general_log = OFF; -- Turn ON for debugging
