module github.com/database-intelligence/db-intel/internal/queryselector
...
replace (
	github.com/database-intelligence/db-intel/internal/featuredetector => ../featuredetector
)
